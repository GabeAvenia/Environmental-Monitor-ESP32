...
private:
    Adafruit_SHT4x sht4;               ///< Underlying Adafruit driver
    TwoWire* wire;                     ///< I2C bus for communication
    int i2cAddress;                    ///< I2C address of the sensor
    float lastTemperature;             ///< Last temperature reading
    float lastHumidity;                ///< Last humidity reading
    unsigned long tempTimestamp;       ///< Timestamp of last temperature reading
    unsigned long humidityTimestamp;   ///< Timestamp of last humidity reading
